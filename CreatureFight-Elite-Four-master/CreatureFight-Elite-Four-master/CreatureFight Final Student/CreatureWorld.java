...
public class CreatureWorld extends World
{
     ...
     * 
     * @param a String Variable that represent The player one Creature
     ...
     * the switch menu and fight menu
     * 
     * @param a String Variable that represent The player two Creature
     * @return Does not return anything
     */
     ...
     */
    /**
     * Gets the creature defined at the current index of PlayerOneCreatures array
     * 
     * @param integer that represet the index of the PlayerOneCreatures array
     * @return Creature that represent the creatures 
     */
     ...
     */
    /**
     * Gets the creature defined at the current index of PlayerTwoCreatures array
     * 
     * @param integer that represet the index of the PlayerTwoCreatures array
     * @return Creature that represent the creatures 
     */
